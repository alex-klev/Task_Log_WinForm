...
class EmployesCatalog(QtWidgets.QMainWindow):
    def __init__(self, **kwargs):
        ...
        self.ui_employes_catalog.lineEditFilter.textChanged.connect(self.on_filter_text_changed)  # Фильтрация
    ...
    def load_table(self, data):
        ...
        self.ui_employes_catalog.tableView.setModel(self.proxy_model)  # важно: подключаем прокси, а не исходную модель
        
        # 12. Включаем сортировку по клику на заголовок
        self.ui_employes_catalog.tableView.setSortingEnabled(True)
        #! #########################
